...
public class SellerOrderInfoDetail extends PrintFriendliness {
    ...
    /**
     * 风控状态(相关枚举：RiskVerifiedStatusEnum)
     */
     ...
     * 订单商品信息
     */
    private SellerOrderProductInfo[] products;
    ...
    public SellerOrderProductInfo[] getProducts() {
        return products;
    }

    public void setProducts(SellerOrderProductInfo[] products) {
